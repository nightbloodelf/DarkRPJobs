...
TEAM_CHIEF = DarkRP.createJob("Police Officer Cheif", {
	color = Color(20, 20, 255, 255),
	model = "models/player/uk_police/uk_police_09.mdl",
...
*/
AddDoorGroup("Cops and Mayor only", TEAM_CHIEF, TEAM_POLICE, TEAM_MAYOR, TEAM_ADMIN)
